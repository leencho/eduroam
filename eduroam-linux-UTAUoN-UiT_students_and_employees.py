...
Config.instname = "UiT The Arctic University of Norway"
Config.profilename = "UiT (students and employees)"
Config.url = "https://en.uit.no/om/orakelet"
Config.email = "orakel@uit.no"
Config.title = "eduroam CAT"
Config.server_match = "uit.no"
...
Config.user_realm = "uit.no"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius1.uit.no', 'DNS:radius2.uit.no']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@uit.no"
